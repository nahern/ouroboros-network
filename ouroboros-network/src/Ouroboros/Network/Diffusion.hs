    ...
    withLocalSocket iocp tracer daLocalAddress $ \localSnocket localSocket -> do
      ...
      withConnectionManager
        ...
        Async.withAsync
          ...
          let connectionManagerArguments :: NodeToNodeConnectionManagerArguments
              connectionManagerArguments =
                ConnectionManagerArguments {
              ...
              Async.withAsync
                ...
                case cmdInMode of
                  ...
                  HasInitiator CMDInInitiatorMode -> do
                    let connectionHandler :: NodeToNodeConnectionHandler InitiatorMode Void
                        connectionHandler =
                          makeConnectionHandler
                            dtMuxTracer
                            SingInitiatorMode
                  ...
                  HasInitiatorResponder (CMDInInitiatorResponderMode controlChannel observableStateVar) -> do
                    let connectionHandler :: NodeToNodeConnectionHandler InitiatorResponderMode ()
                        connectionHandler =
                          makeConnectionHandler
                             dtMuxTracer
...
-- | Any version before introduction of 'TxSubmission2' must run in
-- compatibility mode.
--
nodeCompatMode :: NodeToNodeVersion -> Bool
nodeCompatMode = \v -> v < NodeToNodeV_7

localCompatMode :: NodeToClientVersion -> Bool
localCompatMode = \_ -> False
