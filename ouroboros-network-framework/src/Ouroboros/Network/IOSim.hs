...
initScriptSTM :: MonadSTMTx stm tvar tmvar tqueue tbqueue
              => Script a
              -> stm (tvar (Script a))
initScriptSTM = LazySTM.newTVar

stepScriptSTM :: MonadSTMTx stm tvar tmvar tqueue tbqueue
              => tvar (Script a) -> stm a
...
-- | 'BearerInfo' without attenuation and instantenous connect delay.  It also
