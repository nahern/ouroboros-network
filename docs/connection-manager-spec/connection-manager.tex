...
\begin{figure}[p]
  {\hspace{-3cm}\begin{tikzpicture}[scale=0.66]
    ...
    \draw[->] (UnnegotiatedStateOut.340)       to [out=-60, in=90]
                                               node[fill=white,right=-26pt,pos=0.25]{\small\NegotiatedDupOut}          (OutboundStateDupTau.13);
    ...
    \draw[->]         (OutboundStateDupTau.150) to [out=90,in=-170]
                                                node[fill=white,pos=0.15,left=-60pt]{\small\DemotedToColdDupLoc}       (InboundIdleStateDup.180);
...
\begin{figure}[p]
  {\hspace{-3cm}\begin{tikzpicture}[scale=0.66]
    ...
    \draw[->,requestOutboundArr] (UnnegotiatedStateOut.340)
                                   to [out=-60, in=90]
                                   node[fill=white,right=-26pt,pos=0.25]{\small\NegotiatedDupOut}
    ...
    \draw[->,unregisterOutboundArr]     (OutboundStateDupTau.150) to [out=90,in=-170]
                                          node[fill=white,pos=0.15,left=-60pt]{\small\DemotedToColdDupLoc}
